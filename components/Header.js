    ...
    return(
     <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
            ...
            className="flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600" type = "text" placeholder={placeholder || "Start your search"} />
        ...
        {searchInput && (
            <div className="flex flex-col col-span-3 mx-auto">
                ...
                <div className="flex items-center border-b">
                    ...
                    onChange = {e => setNoOfGuests(e.target.value)} min = {1} type = "number" className="w-12 pl-2 text-lg outline-none text-red-400"></input>
                </div>
                <div className="flex ">
